...
import BannerImage from 'assets/banner-image-1-cropped.png';
        ...
        <Flex sx={styles.banner.row}>
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              ...
              <Heading as="h3">
                Përmirëso biznesin me Quire
              </Heading>
              <Text as="p">
                Në një botë teknologjie, një website për biznesin tuaj është një domosdoshmëri. < br />
                Quire ju mundëson krijimin e një website sipas pritshmërive tuaja pa shumë shpenzime!
              </Text>
          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.imageBox}>
              <Box sx={styles.banner.imageInner}>
                <Image src={BannerImage} alt="" width="500"/>
              </Box>
            </Box>
          </Box>
        </Flex>
