            ...
            <Box className="my-auto">
              <Box sx={styles.ctaThree.content}>
                <BlockTitle
                  ...
                  tagline="Pse ju duhet një website?"
                  heading={
                    'Një website i ri do të jetë një faktor shumë i rëndësishëm për rritjen e biznesit tuaj.'
                  }
                />
                <Text as="p">
                  {
                    'Website ju siguron shumë gjëra që janë të pamundura me anë të mënyrave të tjera.'
                  }
                </Text>
              </Box>
            </Box>
          ...
          <Box sx={styles.ctaThree.colOne}>
            <Grid sx={styles.ctaThree.grid}>
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as="p">{'Ju mund të përdorni websiten për të reklamuar biznesin tuaj!'}</Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as="p">
                  {'Do të jetë më e thjeshtë të krijoni klientë të rinj pasi website do të jetë lehtësisht i aksesueshëm 24/7'}
                </Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
                ...
                <Text as="p">{'Në një website ju mund të organizoni të gjithë informacionin e nevojshëm për klientët'}</Text>
              </Box>
              <Box sx={styles.ctaThree.box}>
