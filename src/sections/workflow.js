...
const workflowData = [
  {
    title: 'Na kontaktoni.',
    text:
      'Mund të na kontaktoni më poshtë dhe do t\'ju përgjigjemi sa më shpejt të jetë e mundur.',
  },
  {
    title: 'Zgjidhni një plan.',
    text:
      'Zgjidhni llojin e websites që ju nevojitet.',
  },
  {
    title: 'Ne krijojmë websiten tuaj.',
    text:
      'Përpara se të bëhet publike ju do të jeni në dijeni të çdo hapi dhe do të mund të bëni ndryshime në website.',
  },
  {
    title: 'Publiko!',
    text:
      'Pasi website të jetë gati ai do të publikohet dhe do të jetë i aksesueshëm nga kushdo.',
  },
];
    ...
    <Box as="section" sx={styles.workflow}>
      <Container>
        <BlockTitle
          ...
          tagline="Si funksionon?"
          heading="Më anë të disa hapa  e të thjeshtë: "
        />
